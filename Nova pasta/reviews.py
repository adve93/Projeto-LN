...
train_data = pd.read_csv('C:/Users/tiago/OneDrive/Documentos/IST/LN/mp1/Projeto/Projeto-LN/P2/train.txt', sep='\t', names=['label', 'review'])

with open('C:/Users/tiago/OneDrive/Documentos/IST/LN/mp1/Projeto/Projeto-LN/P2/test_just_reviews.txt', 'r') as file:
